...
**Note on Dual-Repo Architecture:**
SWALPA is split into two repositories. This repo (`swalpa`) represents the compiled, public-facing static site deployed to Cloudflare Pages. All heavy research, python generation scripts, and AI-agent protocols live in the private supersystem repo (`swalpa-private`).
